...
// Query: *[_type == "restaurantPage" && _id == "restaurantPage"][0]{    heroHeadline,    heroImage {   ...,  asset->{    _id,    url,    metadata { dimensions, lqip, palette }  },  alt },    pitchSection { text, ctaLabel },    craftSection {      title, description, ctaLabel,      primaryImage {   ...,  asset->{    _id,    url,    metadata { dimensions, lqip, palette }  },  alt },      secondaryImage {   ...,  asset->{    _id,    url,    metadata { dimensions, lqip, palette }  },  alt }    },    ambianceSection {      title, tagline, ctaLabel,      image {   ...,  asset->{    _id,    url,    metadata { dimensions, lqip, palette }  },  alt }    },    reservationSection { title, description },    seo {   metaTitle,  metaDescription,  ogImage { ..., asset->{ _id, url } },  noIndex }  }
...
// Query: *[_type == "menuPage" && _id == "menuPage"][0]{    pageIntro { eyebrow, title, subtitle, ctaLabel },    photoStrip[]{   ...,  asset->{    _id,    url,    metadata { dimensions, lqip, palette }  },  alt },    reservationSection { title, description },    dietaryInfo,    seo {   metaTitle,  metaDescription,  ogImage { ..., asset->{ _id, url } },  noIndex }  }
...
// Query: *[_type == "hotelPage" && _id == "hotelPage"][0]{    hero {      eyebrow, title, subtitle, primaryCtaLabel, secondaryCtaLabel,      image {   ...,  asset->{    _id,    url,    metadata { dimensions, lqip, palette }  },  alt }    },    quote,    amenitiesSection {      eyebrow, title,      items[]{ title, description }    },    reservationSection {      eyebrow, title, description, ctaLabel,      image {   ...,  asset->{    _id,    url,    metadata { dimensions, lqip, palette }  },  alt }    },    seo {   metaTitle,  metaDescription,  ogImage { ..., asset->{ _id, url } },  noIndex }  }
